...
class Controller extends BaseController
{
    ...
    public function search(Request $request) {
        ...
        $navAds = Ads::where('position', 'navbar')->orderBy('created_at', 'DESC')->get()->first();

        return view('sports.pages.single.search', [
            'navAds' => $navAds,
            'logo' => $logo,
            'lang' => $lang,
            'posts' => $posts,
 ...
 // public function sendEmail(Request $request)
    ...
    public function singlePost(Request $request, $slug)
    {
        ...
        return view('sports.pages.single.post', [
            'navAds' => $navAds,
            'logo' => $logo,
            'tags' => $tags,
            'provinces' => $provinces,
    ...
    public function singleVideo(Request $request, $slug)
    {
        ...
        return view('sports.pages.single.video', [
            'navAds' => $navAds,
            'logo' => $logo,
            // 'tags' => $tags,
            // 'provinces' => $provinces,
    ...
    public function videos(Request $request)
    {
        ...
        return view('sports.pages.videos', [
    ...
    public function category(Request $request, $category)
    {
        ...
        return view('sports.pages.category', [
    ...
    public function province(Request $request)
    {
        ...
        return view('sports.pages.province', [
            'navAds' => $navAds,
            'logo' => $logo,
            'lang' => $lang,
            'posts' => $posts,
    ...
    public function gallery(Request $request)
    {
        ...
        return view('sports.pages.gallery', [
            'navAds' => $navAds,
            'logo' => $logo,
            'lang' => $lang,
            'posts' => $posts,
    ...
    public function contactUs(Request $request)
    {
        ...
        return view('sports.pages.contactUs', [
            'navAds' => $navAds,
            'logo' => $logo,
            'lang' => $lang,
            'posts' => $posts,
    ...
    public function aboutUs(Request $request)
    {
        ...
        return view('sports.pages.aboutUs', [
            'navAds' => $navAds,
            'logo' => $logo,
            'lang' => $lang,
            'posts' => $posts,
    ...
    public function singleProvince(Request $request, $province)
    {
        ...
        $logo = MySite::orderBy('created_at', 'DESC')->get()->first();
        $navAds = Ads::where('position', 'navbar')->orderBy('created_at', 'DESC')->get()->first();
        $sideAds = Ads::with('prv')->whereHas('prv', function ($query) use ($province) { $query->where('province', $province); })->orderBy('created_at', 'DESC')->get()->first();

        return view('sports.pages.single.province', [
            'sideAds' => $sideAds,
            'navAds' => $navAds,
            'logo' => $logo,
            'lang' => $lang,
