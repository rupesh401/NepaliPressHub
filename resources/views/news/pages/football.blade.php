        ...
        <div class="page-breadcrumbs">
            <h1 class="section-title">
                <img style="width: 30px" class="img-fluid"
                    src="{{ "$pF/storage/uploads/league/logo/" . @$results[0]->match->home->league[0]->logo }}" alt="Image" />
                                            ...
                                            <div class="league-result">
                                                <ul>
                                                    <li class="list-tag p-1">
                                                        <div class="row">
                                                            <div class="col-4 filter-button text-center yesterday" onclick="yesterdayMatch()">
                                                                <a class="a-tag">
                                                            ...
                                                            <div class="col-4 filter-button text-center today filter-active" onclick="todayMatch()">
                                                                <a class="a-tag">
                                                            ...
                                                            <div class="col-4 filter-button text-center tomorrow" onclick="tomorrowMatch()">
                                                                <a class="a-tag">
