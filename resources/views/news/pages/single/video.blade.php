...
<div class="container">
    <div class="page-breadcrumbs">
        @if ($lang == 'en')
        <h1 class="section-title" style="font-size: 15px"><a href="{{ route('home') }}"> Home </a> > <a href="{{ route('videos') }}"> Videos</a> > {{ $singleVideo->title }}</h1>
        @else
        <h1 class="section-title" style="font-size: 15px"><a href="{{ route('home') }}"> घर </a> > <a href="{{ route('videos') }}"> भिडियोहरू </a> > {{ $singleVideo->title }}</h1>
        @endif
     </div>
    <div class="row">
