            ...
            <div class="post feature-post">
                <div class="entry-header">
                    <div class="entry-thumbnail">
                        <img style="width: 1200px; height: 600px; object-fit:cover;" class="img-fluid" src='{{ ("$pF/storage/uploads/posts/".$post->image) }}'
                            alt="Image" />
                    </div>
                ...
                <div class="post-content">
                    <div class="entry-meta">
                        <ul class="list-inline">
                            <li class="publish-date"><i class="fa fa-clock-o"></i><a> {{ $post->created_at->format('F d, Y') }} </a></li>
